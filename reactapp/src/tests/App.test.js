...
test("State_renders_home_component_with_title_and_description", () => {
  render(
    <MemoryRouter>
      <Home />
    </MemoryRouter>
...
test("State_home_component_renders_get_your_spice_merchant_franchise_button_with_link_to_apply", () => {
  render(
    <MemoryRouter>
      <Home />
    </MemoryRouter>
...
test("State_renders_navbar_in_App_component_with_links", () => {
  render(<App />);
...
test("ErrorHandling_checks_link_destinations", () => {
  render(
    <MemoryRouter>
      <NavBar />
    </MemoryRouter>
...
test("State_renders_footer_component_with_copyright_text", () => {
  render(<Footer />);
...
test("Axios_fetching_and_displaying_spice_applications", async () => {
...
test('Form_submits_valid_application_form', async () => {
  render(
    <MemoryRouter>
      <ApplyForm />
    </MemoryRouter>
...
test('Form_submits_invalid_application_form', () => {
  render(
    <MemoryRouter>
      <ApplyForm />
    </MemoryRouter>
...
test('Routes_checks_all_components_and_routes', () => {
  render(<App />);
